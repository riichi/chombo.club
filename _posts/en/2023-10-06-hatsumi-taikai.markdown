...
With representants of **9** different EMA countries and a total number of **80** contestants, the current MERS tournament ranking is **3.0** (with 4.0 being the maximum).\
